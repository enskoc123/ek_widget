...
String? contentText;
  ...
  ExpendText({this.backGroundColor, this.tittleText, this.contentText});
}
    ...
    return InkWell(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color:widget.backGroundColor ?? Color(0xff6F12E8).withOpacity(0.5),
              blurRadius: 20,
              offset: Offset(0, 10),
            ),
          ],
        ...
        child: isTapped
          ...
          children: [
            ...
            Text(
              isTapped
                  ? ''
                  :widget.contentText ?? 'Widgets that have global keys reparent '
