...
class LineHeaderTextLalila extends StatelessWidget {
  String? text;
  ...
  LineHeaderTextLalila({this.text, this.color, this.fontSize,this.shadowColor,this.backGroundColor, this.fontWeight,this.letterSpace,this.wordSpace,this.googleFonts});
